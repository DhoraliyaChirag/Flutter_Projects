  ...
  static List<Food>? generatePopularFood() {
    return [
      ...
      Food(
          ...
          about:
          'm Noodle Soup, or Toshikoshi Soba, symbolizes good luck in the new year and is traditionally eaten by the Japanese on the 31st of December.',
          highLight: false),
    ];
  }
}
